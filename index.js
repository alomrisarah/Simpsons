const episodes = [
 ...
 },
 {
  ...
  airDate: "1990-01-14T00:00:00.000Z",
  thumbnailUrl: "BartTheGenius1.jpg",
  id: 2,
 },
 {
  season: 1,
...
episodes.forEach((episode) => {
 ...
 episodeCard.className = "col-lg-3 col-md-6 col-sm-12 mb-4"
 episodeCard.innerHTML = `
        <div class="card">
            <img src="${episode.thumbnailUrl}" alt="${episode.name}" class="card-img-top">
            <div class="card-body">
                <h3 class="card-title">${episode.name}</h3>
                <p class="card-text"><strong>Season:</strong> ${episode.season} | <strong>Episode:</strong> ${episode.episode} | <strong>Rating:</strong> ${episode.rating}</p>

                <button class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapseDescription${episode.id}" aria-expanded="false" aria-controls="collapseDescription${episode.id}">
                Description
                </button>
                <div class="collapse" id="collapseDescription${episode.id}">
                    <p class="card-text">${episode.description}</p>
                </div>
            </div>
        </div>
    `
 document.getElementById("episodeGrid").appendChild(episodeCard)
})
